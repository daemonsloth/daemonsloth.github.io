...
const PROFILE = {
  ...
  about: {
    currentFocus: {
      ...
      description:
        'Private peer-to-peer communication, secure identity, and verifiable media for mobile products.'
    },
    researchLens: {
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        'Built the Push Interceptor module for seamless Quick Share D2D workflows.',
        'Led Aadhaar Verifiable Credentials and C2PA content-authenticity proofs of concept for Samsung products.',
        'Designed mGrid, a decentralized mobile compute framework for atomic off-chain task sharing.'
      ]
    },
    {
  ...
  education: [
    ...
    },
    {
      ...
      degree: 'BTECH (HONS) IN COMPUTER SCIENCE · CGPA 8.89 / 10.0',
      description:
